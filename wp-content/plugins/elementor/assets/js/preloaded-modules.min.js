        ...
        (elementorFrontend.elementsHandler.elementsHandlers = {
          ...
          elementorFrontend.on("components:init", () => {
            delete elementorFrontend.utils.lightbox,
              (elementorFrontend.utils.lightbox = new p.default());
          });
      });
    },
    3896: (e, t, s) => {
      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        initModal: function () {
          const t = (e.exports.modal = elementorFrontend
            .getDialogsManager()
        ...
        setVideoContent: function (e) {
          ...
          if ("hosted" === e.videoType) {
            ...
            let s = elementorFrontend.utils.baseVideoLoader;
            -1 !== e.url.indexOf("vimeo.com")
        ...
        getShareLinks: function () {
          const { i18n: e } = elementorFrontend.config,
            ...
            o = s("<div>", { class: i.slideshow.shareLinks }),
            a = this.getSlide("active"),
            r = a.find(n.image),
            l = a.data("elementor-slideshow-video");
          let d;
          return (
            (d = l || r.attr("src")),
            s.each(t, (e, t) => {
        ...
        createShareLink: function (e, t) {
          ...
          if ("pinterest" === e) s.image = encodeURIComponent(t);
            ...
            const e = elementorFrontend.utils.urlActions.createActionHash(
              "lightbox",
              { id: this.id, url: t }
            );
          ...
          if (s || i || n || o) {
            if (
              ...
              s.on("click", (e) => {
                ...
                (l.$shareMenu = t("<div>", { class: r.shareMenu }).append(s)),
                l.$iconShare
                  .add(l.$shareMenu)
            ...
            return (
              ...
              s &&
                ((l.$counter = t("<span>", { class: r.counter })),
        ...
        setSlideshowContent: function (e) {
          const { i18n: t } = elementorFrontend.config,
            s = jQuery,
            i = 1 === e.slides.length,
            n = "" !== elementorFrontend.getKitSettings("lightbox_title_src"),
            o =
              "" !==
            ...
            l = r.slideshow,
            d = s("<div>", { class: l.container }),
            c = s("<div>", { class: l.slidesWrapper });
          let h, u;
          e.slides.forEach((e) => {
            ...
            if (e.video) {
              ...
              const i = s("<div>", { class: r.playButton }).html(
                s("<i>", { class: r.playButtonIcon, "aria-label": t.playVideo })
              );
              n.append(i);
            } else {
            ...
            d.prepend(this.elements.$header).append(c),
            i ||
              ((h = s("<div>", {
                class: l.prevButton + " " + r.preventClose,
                "aria-label": t.previous,
              }).html(s("<i>", { class: l.prevButtonIcon }))),
              (u = s("<div>", {
                class: l.nextButton + " " + r.preventClose,
                "aria-label": t.next,
              }).html(s("<i>", { class: l.nextButtonIcon }))),
              d.append(u, h),
              (this.$buttons = this.$buttons.add(u).add(h))),
            a &&
              ((this.elements.$footer = this.getSlideshowFooter()),
              d.append(this.elements.$footer)),
            this.setSettings("hideUiTimeout", ""),
            d.on("click mousemove keypress", this.showLightboxUi);
          ...
          p.onShow = async () => {
            m();
            const t = {
              pagination: { el: "." + l.counter, type: "fraction" },
            ...
            i || (t.navigation = { prevEl: h, nextEl: u }),
              e.swiper && s.extend(t, e.swiper);
            const n = elementorFrontend.utils.swiper;
            (this.swiper = await new n(d, t)),
              d.data("swiper", this.swiper),
        ...
        playSlideVideo: function () {
          ...
          r.onApiReady((e) => {
            "youtube" === a
              ...
              : "vimeo" === a && this.prepareVimeoVideo(e, l, i, n, o);
          }),
