...
(window.Modernizr = (function (e, t, n) {
              ...
              /^range$/.test(o) && E.style.WebkitAppearance !== n
                ? (g.appendChild(E),
                  ...
                  (r =
                    i.getComputedStyle &&
                    "textfield" !==
                      i.getComputedStyle(E, null).WebkitAppearance &&
                    0 !== E.offsetHeight),
                  g.removeChild(E))
                : /^(search|tel)$/.test(o) ||
                  (r = /^(url|email)$/.test(o)
  ...
  var f,
    ...
    $ = function (e, n, r, o) {
      ...
      return (
        ...
        u
          ...
          : (f.parentNode.removeChild(f), (g.style.overflow = s)),
        !!a
      );
    },
    z = function (t) {
    ...
    F = {}.hasOwnProperty;
  (d =
    i(F, "undefined") || i(F.call, "undefined")
      ? function (e, t) {
    ...
    (N.rgba = function () {
      return (
        r("background-color:rgba(150,255,150,.5)"), a(b.backgroundColor, "rgba")
      );
    }),
    (N.hsla = function () {
      return (
    ...
    (N.svg = function () {
      return (
        !!t.createElementNS && !!t.createElementNS(j.svg, "svg").createSVGRect
      );
    }),
    ...
    (N.smil = function () {
      return (
        !!t.createElementNS &&
        /SVGAnimate/.test(x.call(t.createElementNS(j.svg, "animate")))
      );
    }),
    (N.svgclippaths = function () {
      return (
        !!t.createElementNS &&
        /SVGClipPath/.test(x.call(t.createElementNS(j.svg, "clipPath")))
      );
    });
  for (var O in N)
    d(N, O) &&
      ((f = O.toLowerCase()), (m[f] = N[O]()), A.push((m[f] ? "" : "no-") + f));
  return (
    m.input || u(),
    ...
    (function (e, t) {
      ...
      function a(e, n) {
        ...
        n = n || o(e);
        for (
          var i = n.frag.cloneNode(), a = 0, c = r(), s = c.length;
          a < s;
          a++
        )
          i.createElement(c[a]);
